...
<img src="logo.png" style="width:69.84px;height:75.76px; margin-top:0.6%;margin-left:0.6%;"><h1 style="color:black; font-family:Comic Sans MS, cursive, sans-serif; font-size:30px; font-weight: bold; margin-top:-4.75%; margin-left:1.1%;"  align ="center">Indian Institute Of Technology,Jodhpur</h1>
	        ...
	        <div class="transbox">
                    ...
                    <div class="row">
                            ...
                            <div class="input-field col s6" style="width:450px; margin-left:12.5%;">
                              ...
                              <p style="color:#009688">Select File to Upload :(Size<2MB)</p>
                            </div>
                    </div>

<ul>
  ...
  <li><a href="request_layout.php">Request Grant</a></li>
  <li><a href="pendingGrants.php">View Pending Grants</a></li>
  <li><a href="oldGrants.php">View Old Grants</a></li>
...
if(isset($_SESSION['login'])==true){
	if($_SESSION["obj"]->getUserName()!="admin"){
		...
		$result = $_SESSION["obj"]->viewGrants("NonPending");

...
<html>
    <head>
        <title>Grant Acceptance Service IIT Jodhpur</title>
        <style>
            html, body {
    ...
    <body>
        <div id="container">
        	<br>
            <img class="custom4" align="right" src="Logo_IITJ.png" alt="college logo" style="width:70px;height:70px;"><h3 class="custom2" align ="left">Indian Institute Of Technology,<br>Jodhpur</h3></p><br>
		...
		can collect your money ( Rs.<?php echo $grantMoney?> ) from admin office by showing this acceptance letter.<br>
			</pre>
			<br><br><br><br><br><br>
